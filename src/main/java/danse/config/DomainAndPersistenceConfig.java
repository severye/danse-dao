...
@EnableJpaRepositories(basePackages = { "danse.repositories","danse.security"})
@EnableAutoConfiguration
@ComponentScan(basePackages = { "danse" })
@EntityScan(basePackages = { "danse.entities","danse.security"})
